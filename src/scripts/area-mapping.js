...
export default countriesAreaMapping => {

    //define constants
    const root = pack(dataCountries);
...
const pack = (dataCountries) => {
    ...
    const rootNode = d3.hierarchy(dataCountries);
    rootNode.sum(node => node.area);
    rootNode.sort((a, b) => b.area - a.area);
